    ...
    <div class="row text-center mt-4">
        <?php foreach ($peralatan_olahraga as $brg) : ?>
            <div class="card ml-3 mb-3" style="width: 16rem;">
                <img src="<?php echo base_url() . 'uploads/' . $brg->gambar ?>" class="card-img-top" alt="..." height="">
                <div class="card-body">
                    ...
                    <a href="<?= site_url('/dashboard/detail/' . $brg->id_brg) ?>" class="btn btn-sm btn-success">Detail</a>
                </div>
            </div>
        <?php endforeach; ?>
